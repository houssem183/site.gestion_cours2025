...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT c.id_cours, cat.nom_categorie, c.titre_cours, form.prix_cours,
            image_cours , description_cours, f.nom_formateur AS formateur, f.image_formateur
            FROM cours c
            JOIN categories cat ON c.id_categorie = cat.id_categorie
            JOIN formation form ON form.id_cours = c.id_cours
            JOIN formateurs f ON form.id_formateur = f.id_formateur
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              ...
              <p><a href="#"><?= $le_cour['prix_cours'] ?></a></p>
            </div>
